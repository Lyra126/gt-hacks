...
from api.endpoints import agent, auth, timeline, patient, organization, trials, emr, analytics, enrollments, crc_management
...
app.include_router(crc_management.router, prefix="/api", tags=["CRC Management"])
